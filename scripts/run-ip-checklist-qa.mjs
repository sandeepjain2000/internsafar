 ...
 *   node scripts/run-ip-checklist-qa.mjs --only AUTH-8 --apply [baseUrl]
 *
...
import { runFixtureCases, setTwoFactorFlag } from './lib/ipQaFixtureCases.mjs';
...
async function main() {
  console.log(`IP comprehensive checklist QA — base=${BASE} headless=true${ONLY ? ` only=${ONLY}` : ''}`);
