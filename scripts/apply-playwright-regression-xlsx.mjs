...
const TITLE_TO_TC = [
  ...
  [/IS-065|active duplicate apply/, ['TC-IS-07-007']],
  [/IS-066|withdraw then reapply/, ['TC-IS-07-024']],
  [/session refresh|stays on \/candidate after reload|stays on \/employer after reload|stays on \/superadmin after reload|cannot keep \/employer/, ['TC-IS-18-048']],
  [/JOURNEY-EMP-02|postings list/, ['TC-IS-09-017']],
  [/JOURNEY-EMP-03|State and City location/, ['TC-IS-09-016']],
