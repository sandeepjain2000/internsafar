  ...
  return (
    <div className="ip-emp-cand ip-mobile-bleed">
      ...
      <div className="ip-ec-panel">
        ...
        >
          ...
          <div className="ip-tf__actions">
            ...
            <button type="button" className="ip-ec-sbtn is-primary" onClick={applyFiltersNow}>Apply</button>
          </div>
        </IpTableFiltersShell>
      ...
      <div className="ip-ec-context">
        <div className="ip-ec-summary ip-ec-summary--inline">
      ...
      <div className="ip-ec-layout ip-ec-layout--single">
        <div className="ip-ec-results">
          ...
          <p className="ip-ec-privacy-note">
            Results respect each candidate&apos;s discovery settings. Contact details stay restricted until the platform workflow allows access. Existing applications, invitations, and shortlists are shown to help avoid duplicate outreach.
          </p>
        </div>
      </div>
