 ...
 * the registration form (no portal session). Without the cookie, Google is not a login
 * method (redirect GoogleLoginDisabled). Nothing here trusts a client-supplied email: the
